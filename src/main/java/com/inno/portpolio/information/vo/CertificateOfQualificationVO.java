...
*/
@Data
@EqualsAndHashCode(of={"infoNo","crqfcNo"})
public class CertificateOfQualificationVO {
	...
	@NotBlank(groups = {InsertGroup.class,DeleteGroup.class})
	private String crqfcCode;
	
	private String crqfcAgency;
	@NotBlank(groups = {InsertGroup.class,DeleteGroup.class})
	private String crqfcDate;
}
